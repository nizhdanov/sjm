...
-- CreateTable
CREATE TABLE "TeachersOfFaculty" (
    "teacherId" TEXT NOT NULL,
    "facultyTitle" TEXT NOT NULL,

    CONSTRAINT "TeachersOfFaculty_pkey" PRIMARY KEY ("teacherId","facultyTitle")
);
...
-- AddForeignKey
ALTER TABLE "TeachersOfFaculty" ADD CONSTRAINT "TeachersOfFaculty_facultyTitle_fkey" FOREIGN KEY ("facultyTitle") REFERENCES "Faculty"("title") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TeachersOfFaculty" ADD CONSTRAINT "TeachersOfFaculty_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "Teacher"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
